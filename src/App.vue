<template>
  <div id="app" class="relative">
    <!-- Esta es la cabecera que se ve en ordenadores-->
    <div class="xl:block lg:block p-4 w-full text-center border-b border-blue-100 sm:block">
      <div class="pt-4 flex justify-center">
        <svg x="0px" y="0px" viewBox="0 0 512 512" class="lg:w-16 sm:w-12 xl:w-24">
          <path
            d="M505.316,6.671c-0.025-0.024-0.052-0.045-0.076-0.069C501.005,2.405,495.169,0,489.212,0h-0.03
          ...
          <path
            d="M94.026,333.076c-23.657-23.656-64.022-6.61-64.02,26.511c0,10.011,3.903,19.426,10.99,26.512
          ...
          <path
            d="M152.361,407.051c-15.421,0-28.668,8.854-34.572,23.108c-5.933,14.324-2.845,29.995,8.058,40.896
      ...
      <br />
      <h1
        class="xl:text-3xl sm:text-xl lg:text-2xl font-semibold mb-4"
      >¡Bienvenido a la tijera de oro!</h1>
      <div class="flex justify-center sm:hidden lg:block xl:block">
    ...
    <router-view />
    <!-- Esto es la barra inferior que se ve en móviles-->
    <div
      class="xl:hidden lg:hidden sm:w-full sm:bg-white sm:border-t border-gray-300 sm:h-16 sm:fixed sm:bottom-0 sm:flex"
    >
      <div class="w-1/3 z-10 text-sm">
        <router-link
          to="/"
          class="sm:flex sm:flex-col sm:justify-center sm:items-center p-3 focus:outline-none"
        >
          <img src="@/assets/img/calendar.png" alt="admin" class="w-6" />
          <span>Calendario</span>
        </router-link>
      </div>
      <div class="w-1/3 z-10 text-sm">
        <router-link to="/citas" class="sm:flex sm:flex-col sm:justify-center sm:items-center p-3">
          <img src="@/assets/img/check.png" alt="admin" class="w-6" />
          <span>Cita</span>
        </router-link>
      </div>
      <div class="w-1/3 z-10 text-sm">
